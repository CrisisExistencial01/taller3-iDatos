...
export default function AnalyticsPage() {
    ...
    const [selectedYearTopCountries, setSelectedYearTopCountries] = React.useState<number | null>(null)
    const [selectedYearRegional, setSelectedYearRegional] = React.useState<number | null>(null)
